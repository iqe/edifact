...
class SegmenterTest < Minitest::Test
  ...
  def test_unexpected_eof
    assert_raises_msg(/Unexpected end of input .* 13/) { input("AAA") }
    assert_raises_msg(/Unexpected end of input .* 14/) { input("AAA+") }
    assert_raises_msg(/Unexpected end of input .* 15/) { input("AAA+x") }
    assert_raises_msg(/Unexpected end of input .* 16/) { input("AAA+x:") }
    assert_raises_msg(/Unexpected end of input .* 17/) { input("AAA+x:y") }
  end
